    ...
    return createPortal(_jsxs("div", { role: "dialog", "aria-modal": "true", "aria-label": title, style: {
        ...
        ` }), _jsxs("div", { style: {
                            ...
                            borderBottom: '1px solid var(--color-border)',
                                            ...
                                            marginTop: 4,
                                        }, children: description }))] }), _jsx("button", { onClick: onClose, "aria-label": t('common.actions.close'), style: {
                                    width: 28,
                                    height: 28,
                                    display: 'flex',
                                    alignItems: 'center',
...
export function ConfirmModal({ isOpen, onClose, onConfirm, title, description, confirmLabel, variant = 'danger', }) {
    const { t } = useTranslation();
    const resolvedConfirmLabel = confirmLabel ?? t('common.actions.confirm');
    return (_jsx(Modal, { isOpen: isOpen, onClose: onClose, title: title, description: description, size: "sm", footer: _jsxs(_Fragment, { children: [_jsx(Button, { variant: "secondary", size: "sm", onClick: onClose, children: t('common.actions.cancel') }), _jsx(Button, { variant: variant, size: "sm", onClick: onConfirm, children: resolvedConfirmLabel })] }), children: _jsx("div", {}) }));
}
