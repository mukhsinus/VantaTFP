...
export function KpiPage() {
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: isMobile ? 14 : 20, width: '100%', maxWidth: '100%' }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: isMobile ? 'flex-start' : 'center', gap: isMobile ? 10 : 0 }, children: [_jsxs("div", { children: [_jsx("h2", { style: { fontSize: 'var(--text-2xl)', fontWeight: 700, color: 'var(--color-text-primary)' }, children: t('kpi.title') }), _jsx("p", { style: { fontSize: 'var(--text-sm)', color: 'var(--color-text-secondary)', marginTop: 4 }, children: t('kpi.subtitle') })] }), _jsx(Button, { variant: "primary", size: "sm", leftIcon: _jsx("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, children: _jsx("path", { d: "M12 5v14M5 12h14" }) }), children: t('kpi.create') })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: isMobile ? 'flex-start' : 'center', flexDirection: isMobile ? 'column' : 'row', gap: 10 }, children: [_jsx("div", { style: { display: 'flex', gap: 6, flexWrap: 'wrap', width: '100%' }, children: ['ALL', 'WEEKLY', 'MONTHLY', 'QUARTERLY'].map((p) => (_jsx("button", { onClick: () => setPeriod(p), style: {
                            ...
                            }, children: periodLabel(p) }, p))) }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8 }, children: [_jsx("span", { style: { fontSize: 'var(--text-sm)', color: 'var(--color-text-secondary)' }, children: t('kpi.avgProgress') }), _jsxs("span", { style: {
                                    fontSize: 'var(--text-lg)',
                                    fontWeight: 700,
                                    color: progressColor(avgProgress),
                                }, children: [avgProgress, "%"] })] })] }), _jsx("div", { style: { display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fill, minmax(300px, 1fr))', gap: 12 }, children: filtered.map((kpi) => _jsx(KpiCard, { kpi: kpi }, kpi.id)) })] }));
}
const trendIcon = {
...
function KpiCard({ kpi }) {
    ...
    return (_jsxs(Card, { children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }, children: [_jsxs("div", { children: [_jsx("p", { style: { fontSize: 'var(--text-md)', fontWeight: 600, color: 'var(--color-text-primary)' }, children: t(kpi.nameKey) }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }, children: [_jsx(Avatar, { name: t(kpi.assigneeKey), size: "xs" }), _jsx("span", { style: { fontSize: 'var(--text-xs)', color: 'var(--color-text-secondary)' }, children: t(kpi.assigneeKey) })] })] }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }, children: _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 4 }, children: [trendIcon[kpi.trend], _jsx(Badge, { variant: "default", style: { fontSize: 10 }, children: kpi.period === 'WEEKLY'
                                        ? t('kpi.period.weekly')
                                        : kpi.period === 'MONTHLY'
                                            ? t('kpi.period.monthly')
                                            : t('kpi.period.quarterly') })] }) })] }), _jsxs("div", { style: { marginBottom: 12 }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: 6 }, children: [_jsx("span", { style: { fontSize: 'var(--text-xs)', color: 'var(--color-text-secondary)' }, children: t('kpi.progress') }), _jsxs("span", { style: { fontSize: 'var(--text-xs)', fontWeight: 700, color }, children: [pct, "%"] })] }), _jsx("div", { style: {
                            height: 8,
                            borderRadius: 'var(--radius-full)',
                            ...
                            } }) })] }), _jsxs("div", { style: { display: 'flex', justifyContent: 'space-between' }, children: [_jsxs("div", { children: [_jsx("p", { style: { fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)' }, children: t('kpi.actual') }), _jsxs("p", { style: { fontSize: 'var(--text-lg)', fontWeight: 700, color }, children: [kpi.actualValue.toLocaleString(), " ", _jsx("span", { style: { fontSize: 'var(--text-xs)', fontWeight: 400 }, children: t(kpi.unitKey) })] })] }), _jsxs("div", { style: { textAlign: 'right' }, children: [_jsx("p", { style: { fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)' }, children: t('kpi.target') }), _jsxs("p", { style: { fontSize: 'var(--text-lg)', fontWeight: 700, color: 'var(--color-text-secondary)' }, children: [kpi.targetValue.toLocaleString(), " ", _jsx("span", { style: { fontSize: 'var(--text-xs)', fontWeight: 400 }, children: t(kpi.unitKey) })] })] })] })] }));
}
