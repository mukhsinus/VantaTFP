...
export function DashboardPage() {
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: isMobile ? 14 : 24, width: '100%', maxWidth: '100%' }, children: [_jsxs("div", { children: [_jsx("h2", { style: { fontSize: 'var(--text-2xl)', fontWeight: 700, color: 'var(--color-text-primary)' }, children: t('overview.title') }), _jsx("p", { style: { fontSize: 'var(--text-sm)', color: 'var(--color-text-secondary)', marginTop: 4 }, children: t('overview.subtitle') })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }, children: [_jsx(StatCard, { label: t('overview.stats.totalTasks'), value: 48, delta: { value: t('overview.stats.delta.totalTasksWeek'), positive: true }, accent: "var(--color-accent)", icon: _jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.75, children: [_jsx("path", { d: "M9 11l3 3L22 4" }), _jsx("path", { d: "M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" })] }) }), _jsx(StatCard, { label: t('overview.stats.completed'), value: 31, delta: { value: t('overview.stats.delta.completedWeek'), positive: true }, accent: "var(--color-success)", icon: _jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.75, children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M9 12l2 2 4-4" })] }) }), _jsx(StatCard, { label: t('overview.stats.overdue'), value: 5, delta: { value: t('overview.stats.delta.overdueSinceYesterday'), positive: false }, accent: "var(--color-danger)", icon: _jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.75, children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M12 8v4M12 16h.01" })] }) }), _jsx(StatCard, { label: t('overview.stats.inProgress'), value: 12, accent: "var(--color-warning)", icon: _jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.75, children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("polyline", { points: "12 6 12 12 16 14" })] }) })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 360px', gap: 16, width: '100%', maxWidth: '100%' }, children: [_jsxs(Card, { children: [_jsx(CardHeader, { title: t('overview.activity.title'), subtitle: t('overview.activity.subtitle') }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 0 }, children: mockActivity.map((item, index) => (_jsxs("div", { style: {
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 12,
                                        padding: '12px 0',
                                        borderBottom: index < mockActivity.length - 1 ? '1px solid var(--color-border)' : 'none',
                                    }, children: [_jsx(Avatar, { name: t(item.userKey), size: "sm" }), _jsx("div", { style: { flex: 1, minWidth: 0 }, children: _jsx("p", { style: { fontSize: 'var(--text-sm)', color: 'var(--color-text-primary)' }, children: _jsx("span", { style: {
                                                        overflow: 'hidden',
                                                        textOverflow: 'ellipsis',
                                                        whiteSpace: 'normal',
                                                    }, children: t(`overview.activity.${item.actionKey}`, {
                                                        user: t(item.userKey),
                                                        task: t(item.taskKey),
                                                    }) }) }) }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, flexWrap: 'wrap', justifyContent: 'flex-end' }, children: [_jsx(Badge, { variant: typeToVariant[item.type], dot: true, children: item.type === 'success'
                                                        ? t('status.success')
                                                        : item.type === 'warning'
                                                            ? t('status.warning')
                                                            : item.type === 'danger'
                                                                ? t('status.danger')
                                                                : t('status.accent') }), _jsx("span", { style: { fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)', whiteSpace: 'nowrap' }, children: item.time })] })] }, item.id))) })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: 16 }, children: [_jsxs(Card, { children: [_jsx(CardHeader, { title: t('overview.overdue.title') }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 10 }, children: [
                                            ...
                                            t('overview.overdue.items.teamFeedbackSession'),
                                                ...
                                                cursor: 'pointer',
                                            }, children: [_jsx("span", { style: { color: 'var(--color-danger)', flexShrink: 0 }, children: _jsxs("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M12 8v4M12 16h.01" })] }) }), _jsx("p", { style: { fontSize: 'var(--text-sm)', color: 'var(--color-danger)', fontWeight: 500, flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, children: task })] }, task))) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { title: t('overview.progress.title') }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 14 }, children: [
