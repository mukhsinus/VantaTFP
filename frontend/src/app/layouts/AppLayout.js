...
export function AppLayout() {
    ...
    return (_jsxs("div", { className: styles.container, children: [!isMobile && _jsx(Sidebar, {}), _jsxs("div", { className: styles.mainWrapper, style: {
                ...
                }, children: [_jsx(Topbar, {}), _jsxs("main", { className: styles.mainContent, children: [user ? _jsx(TenantTrialExperience, {}) : null, _jsx("div", { className: "page-container", children: _jsx(Outlet, {}) })] })] }), isMobile && _jsx(MobileBottomTabs, {}), _jsx(ToastRenderer, {})] }));
}
